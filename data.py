...
# print(get_new_questions.json().get("results"))
# question_data = get_new_questions.json().get("results")
# print(question_data['results'][0]['category'])
# print(question_data[1]['category'])
# for x in random.choice(question_data):
#     print(x['question'])
